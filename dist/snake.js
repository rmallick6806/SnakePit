...
/***/ function(module, exports, __webpack_require__) {
	...
	var _snake = __webpack_require__(52);
	
	var _snake2 = _interopRequireDefault(_snake);
	
	var _food = __webpack_require__(55);
	
	var _food2 = _interopRequireDefault(_food);
	
	var _board = __webpack_require__(56);
	...
	SnakePit.game = function () {
		...
		let snake1 = new _snake2.default({
			x: 20,
			y: 20,
			speed: 10
		});
		let snake2 = new _snake2.default({
			x: 20,
			y: 50,
			speed: 5
		});
		this.snakes.push(snake1);
		let food = new _food2.default(canvas, board);
		...
		function init() {
			bindEvents();
			_lodash2.default.forEach(game.snakes, (snake, index) => {
				snake.init();
			});
			food.place();
			gameLoopP1();
		...
		function bindEvents() {
			...
			document.addEventListener('keydown', e => {
				let key = e.keyCode;
				let direction = _utils.controlsMap[key];
		...
		function resetPressed() {
			game.pressed = _lodash2.default.mapValues(game.pressed, pressed => {
		...
		function processInput(snake, index) {
			...
			let newDirection = _lodash2.default.findKey(game.pressed, (pressed, direction) => {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fastList = __webpack_require__(53);
	...
	module.exports = function Snake(options) {
		...
		this.checkCollision = (canvas, board, game) => {
			...
			if (head.x < 0 || head.y < 0 || head.x >= canvas.width / board.cellWidth || head.y >= canvas.height / board.cellWidth) {
				game.running = false;
			}
		};
		...
		this.checkSelfCollision = game => {
			...
			let noCollision = snake.segments.reduce((previousValue, currentSegment, index, segments) => {
				let segmentsCollide = _lodash2.default.isEqual(head, currentSegment);
				if (typeof previousValue === 'object') previousValue = true;
				return previousValue && !segmentsCollide;
			});
			if (!noCollision) game.running = false;
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function Board() {
		...
		this.draw = (ctx, snakes, food, elapsed) => {
			...
			_lodash2.default.forEach(snakes, (snake, playerIndex) => {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./app.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./app.css");
...
/***/ function(module, exports) {
	...
	const oppositeDirections = exports.oppositeDirections = {
		LEFT: 'RIGHT',
		RIGHT: 'LEFT',
		UP: 'DOWN',
		DOWN: 'UP'
	...
	const controlsMap = exports.controlsMap = {
		37: 'LEFT',
		38: 'UP',
		39: 'RIGHT',
		40: 'DOWN'
