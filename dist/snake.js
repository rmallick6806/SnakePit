...
/***/ function(module, exports, __webpack_require__) {
	...
	SnakePit.game = function () {
		...
		function checkCollision(snake) {
			...
			if (head.x < 0 || head.y < 0 || head.x >= canvas.width / SnakePit.cellWidth || head.y >= canvas.height / SnakePit.cellWidth) {
				gameRunning = false;
			}
		}
	...
	SnakePit.game2 = function () {
		// Create the canvas
		// game configuration
		let gameRunning = true;
		let food = new SnakePit.food();
		// init snake object
		let snake2 = new SnakePit.snake2();
		var gameTime = Date.now();
		...
		function draw() {
			...
			ctx.fillStyle = 'red';
			ctx.fillRect(food.coordinates.x * SnakePit.cellWidth, food.coordinates.y * SnakePit.cellWidth, 10, 10);
			ctx.strokeRect(food.coordinates.x * SnakePit.cellWidth, food.coordinates.y * SnakePit.cellWidth, snake2.segmentSize, snake2.segmentSize);
		}
